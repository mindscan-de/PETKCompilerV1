...
public class AiDslParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, AiDslGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getSAIMemberAccess().getAlternatives(), "rule__SAIMember__Alternatives");
			builder.put(grammarAccess.getSAIStatementAccess().getAlternatives(), "rule__SAIStatement__Alternatives");
			builder.put(grammarAccess.getSAIIfBlockAccess().getAlternatives(), "rule__SAIIfBlock__Alternatives");
			builder.put(grammarAccess.getSAITerminalExpressionAccess().getAlternatives(), "rule__SAITerminalExpression__Alternatives");
			builder.put(grammarAccess.getSAITerminalExpressionAccess().getValueAlternatives_2_1_0(), "rule__SAITerminalExpression__ValueAlternatives_2_1_0");
			builder.put(grammarAccess.getDataDictionaryValueAccess().getValueAlternatives_1_0(), "rule__DataDictionaryValue__ValueAlternatives_1_0");
			builder.put(grammarAccess.getDataDictionaryBooleanValueAccess().getValueAlternatives_1_0(), "rule__DataDictionaryBooleanValue__ValueAlternatives_1_0");
			...
			builder.put(grammarAccess.getWorkflowFunctionsDefinitionAccess().getGroup(), "rule__WorkflowFunctionsDefinition__Group__0");
			builder.put(grammarAccess.getSAIFieldAccess().getGroup(), "rule__SAIField__Group__0");
			builder.put(grammarAccess.getSAIMethodAccess().getGroup(), "rule__SAIMethod__Group__0");
			builder.put(grammarAccess.getSAIMethodAccess().getGroup_2(), "rule__SAIMethod__Group_2__0");
			builder.put(grammarAccess.getSAIMethodAccess().getGroup_2_1(), "rule__SAIMethod__Group_2_1__0");
			builder.put(grammarAccess.getSAIBlockAccess().getGroup(), "rule__SAIBlock__Group__0");
			builder.put(grammarAccess.getSAIVariableDeclarationAccess().getGroup(), "rule__SAIVariableDeclaration__Group__0");
			...
			builder.put(grammarAccess.getSAISelectionExpressionAccess().getGroup(), "rule__SAISelectionExpression__Group__0");
			builder.put(grammarAccess.getSAISelectionExpressionAccess().getGroup_1(), "rule__SAISelectionExpression__Group_1__0");
			builder.put(grammarAccess.getSAISelectionExpressionAccess().getGroup_1_3(), "rule__SAISelectionExpression__Group_1_3__0");
			builder.put(grammarAccess.getSAISelectionExpressionAccess().getGroup_1_3_1(), "rule__SAISelectionExpression__Group_1_3_1__0");
			builder.put(grammarAccess.getSAISelectionExpressionAccess().getGroup_1_3_1_1(), "rule__SAISelectionExpression__Group_1_3_1_1__0");
			builder.put(grammarAccess.getSAITerminalExpressionAccess().getGroup_0(), "rule__SAITerminalExpression__Group_0__0");
			builder.put(grammarAccess.getSAITerminalExpressionAccess().getGroup_1(), "rule__SAITerminalExpression__Group_1__0");
			builder.put(grammarAccess.getSAITerminalExpressionAccess().getGroup_2(), "rule__SAITerminalExpression__Group_2__0");
			builder.put(grammarAccess.getSAITerminalExpressionAccess().getGroup_3(), "rule__SAITerminalExpression__Group_3__0");
			...
			builder.put(grammarAccess.getWorkflowUIElementMapAccess().getGroup_7(), "rule__WorkflowUIElementMap__Group_7__0");
			...
			builder.put(grammarAccess.getDatadictionaryKeyValuePairAccess().getGroup_1(), "rule__DatadictionaryKeyValuePair__Group_1__0");
			builder.put(grammarAccess.getDataDictionaryValueAccess().getGroup(), "rule__DataDictionaryValue__Group__0");
			builder.put(grammarAccess.getDataDictionaryArrayValueAccess().getGroup(), "rule__DataDictionaryArrayValue__Group__0");
			builder.put(grammarAccess.getDataDictionaryArrayValueAccess().getGroup_2(), "rule__DataDictionaryArrayValue__Group_2__0");
			builder.put(grammarAccess.getDataDictionaryArrayValueAccess().getGroup_2_1(), "rule__DataDictionaryArrayValue__Group_2_1__0");
			builder.put(grammarAccess.getDataDictionaryMapValueAccess().getGroup(), "rule__DataDictionaryMapValue__Group__0");
			builder.put(grammarAccess.getDataDictionaryBooleanValueAccess().getGroup(), "rule__DataDictionaryBooleanValue__Group__0");
			builder.put(grammarAccess.getDataDictionaryStringValueAccess().getGroup(), "rule__DataDictionaryStringValue__Group__0");
			builder.put(grammarAccess.getDataDictionaryNullValueAccess().getGroup(), "rule__DataDictionaryNullValue__Group__0");
			...
			builder.put(grammarAccess.getWorkflowIfStatementAccess().getGroup(), "rule__WorkflowIfStatement__Group__0");
			builder.put(grammarAccess.getWorkflowIfStatementAccess().getGroup_6(), "rule__WorkflowIfStatement__Group_6__0");
			...
			builder.put(grammarAccess.getWorkflowFunctionsDefinitionAccess().getNameAssignment_1(), "rule__WorkflowFunctionsDefinition__NameAssignment_1");
			builder.put(grammarAccess.getWorkflowFunctionsDefinitionAccess().getMembersAssignment_3(), "rule__WorkflowFunctionsDefinition__MembersAssignment_3");
			builder.put(grammarAccess.getSAIMethodAccess().getParamsAssignment_2_0(), "rule__SAIMethod__ParamsAssignment_2_0");
			builder.put(grammarAccess.getSAIMethodAccess().getParamsAssignment_2_1_1(), "rule__SAIMethod__ParamsAssignment_2_1_1");
			builder.put(grammarAccess.getSAIMethodAccess().getBodyAssignment_4(), "rule__SAIMethod__BodyAssignment_4");
			builder.put(grammarAccess.getSAIBlockAccess().getStatementsAssignment_2(), "rule__SAIBlock__StatementsAssignment_2");
			builder.put(grammarAccess.getSAIVariableDeclarationAccess().getExpressionAssignment_2(), "rule__SAIVariableDeclaration__ExpressionAssignment_2");
			builder.put(grammarAccess.getSAIReturnAccess().getExpressionAssignment_1(), "rule__SAIReturn__ExpressionAssignment_1");
			...
			builder.put(grammarAccess.getSAIAssignmentAccess().getRightAssignment_1_2(), "rule__SAIAssignment__RightAssignment_1_2");
			builder.put(grammarAccess.getSAISelectionExpressionAccess().getMemberAssignment_1_2(), "rule__SAISelectionExpression__MemberAssignment_1_2");
			builder.put(grammarAccess.getSAISelectionExpressionAccess().getMethodinvocationAssignment_1_3_0(), "rule__SAISelectionExpression__MethodinvocationAssignment_1_3_0");
			builder.put(grammarAccess.getSAISelectionExpressionAccess().getArgsAssignment_1_3_1_0(), "rule__SAISelectionExpression__ArgsAssignment_1_3_1_0");
			builder.put(grammarAccess.getSAISelectionExpressionAccess().getArgsAssignment_1_3_1_1_1(), "rule__SAISelectionExpression__ArgsAssignment_1_3_1_1_1");
			builder.put(grammarAccess.getSAITerminalExpressionAccess().getValueAssignment_0_1(), "rule__SAITerminalExpression__ValueAssignment_0_1");
			builder.put(grammarAccess.getSAITerminalExpressionAccess().getValueAssignment_1_1(), "rule__SAITerminalExpression__ValueAssignment_1_1");
			builder.put(grammarAccess.getSAITerminalExpressionAccess().getValueAssignment_2_1(), "rule__SAITerminalExpression__ValueAssignment_2_1");
			...
			builder.put(grammarAccess.getWorkflowUIElementMapAccess().getDefaultvalueAssignment_6_1(), "rule__WorkflowUIElementMap__DefaultvalueAssignment_6_1");
			builder.put(grammarAccess.getWorkflowUIElementMapAccess().getOptionsAssignment_7_1(), "rule__WorkflowUIElementMap__OptionsAssignment_7_1");
			...
			builder.put(grammarAccess.getWorkflowDataDictionaryDefinitionAccess().getKeyValuePairsAssignment_3(), "rule__WorkflowDataDictionaryDefinition__KeyValuePairsAssignment_3");
			builder.put(grammarAccess.getDatadictionaryKeyValuePairAccess().getNameAssignment_0(), "rule__DatadictionaryKeyValuePair__NameAssignment_0");
			builder.put(grammarAccess.getDatadictionaryKeyValuePairAccess().getExtendsAssignment_1_1(), "rule__DatadictionaryKeyValuePair__ExtendsAssignment_1_1");
			builder.put(grammarAccess.getDatadictionaryKeyValuePairAccess().getValueAssignment_3(), "rule__DatadictionaryKeyValuePair__ValueAssignment_3");
			builder.put(grammarAccess.getDataDictionaryValueAccess().getValueAssignment_1(), "rule__DataDictionaryValue__ValueAssignment_1");
			builder.put(grammarAccess.getDataDictionaryArrayValueAccess().getValuesAssignment_2_0(), "rule__DataDictionaryArrayValue__ValuesAssignment_2_0");
			builder.put(grammarAccess.getDataDictionaryArrayValueAccess().getValuesAssignment_2_1_1(), "rule__DataDictionaryArrayValue__ValuesAssignment_2_1_1");
			builder.put(grammarAccess.getDataDictionaryMapValueAccess().getKeyValuePairsAssignment_2(), "rule__DataDictionaryMapValue__KeyValuePairsAssignment_2");
			builder.put(grammarAccess.getDataDictionaryBooleanValueAccess().getValueAssignment_1(), "rule__DataDictionaryBooleanValue__ValueAssignment_1");
			builder.put(grammarAccess.getDataDictionaryStringValueAccess().getValueAssignment_1(), "rule__DataDictionaryStringValue__ValueAssignment_1");
			builder.put(grammarAccess.getDataDictionaryNullValueAccess().getValueAssignment_1(), "rule__DataDictionaryNullValue__ValueAssignment_1");
			...
			builder.put(grammarAccess.getWorkflowIfStatementAccess().getConditionAssignment_2(), "rule__WorkflowIfStatement__ConditionAssignment_2");
			builder.put(grammarAccess.getWorkflowIfStatementAccess().getElsePresentAssignment_6_0(), "rule__WorkflowIfStatement__ElsePresentAssignment_6_0");
