...
//			DataDictionaryArrayValue: {}
	...
	protected def HashMap<String, Serializable> getCompiledExecutionInfoMap(WorkflowDefinition workflowDefinition) {
		...
		for(inputelement : workflowinputdefinition.uiElements) {
			...
			val inputinfo = new LinkedHashMap<String,Object>()
			inputinfo.put('__uitype',uitype)
			inputinfo.put('__datatype',inputfielddatatype.typename)
			inputinfo.put('label',uilabel)
